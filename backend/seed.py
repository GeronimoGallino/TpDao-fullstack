...
def seed_mantenimientos(db):
    ...
    mantenimientos = [
        ...
        Mantenimiento(
            id_vehiculo=4,
            id_empleado=3,
            fecha=datetime(2023, 6, 20, tzinfo=timezone.utc),
            km_actual=25000,
            tipo="correctivo",
            costo=30000,
            observaciones="Reparación de frenos delanteros",
            km_prox_mant=10000,
            meses_prox_mant=12
        ),
        Mantenimiento(
            id_vehiculo=4,  # mismo auto que el anterior
            id_empleado=4,
            fecha=datetime(2024, 1, 15, tzinfo=timezone.utc),
            km_actual=35000,
            tipo="preventivo",
            costo=18000,
            observaciones="Cambio de neumáticos",
            km_prox_mant=15000,
            meses_prox_mant=12
        ),
        Mantenimiento(
            id_vehiculo=6,
            id_empleado=2,
            fecha=datetime(2023, 7, 10, tzinfo=timezone.utc),
            km_actual=70000,
            tipo="correctivo",
            costo=45000,
            observaciones="Reemplazo de embrague",
            km_prox_mant=20000,
            meses_prox_mant=18
        ),
        Mantenimiento(
            id_vehiculo=8,
            id_empleado=3,
            fecha=datetime(2023, 8, 5, tzinfo=timezone.utc),
            km_actual=15000,
            tipo="preventivo",
            costo=12000,
            observaciones="Chequeo general y alineación",
            km_prox_mant=10000,
            meses_prox_mant=12
        ),
        Mantenimiento(
            id_vehiculo=10,
            id_empleado=4,
            fecha=datetime(2023, 9, 25, tzinfo=timezone.utc),
            km_actual=85000,
            tipo="correctivo",
            costo=60000,
        ...
        Mantenimiento(
            id_vehiculo=12,
            id_empleado=2,
            fecha=datetime(2023, 10, 30, tzinfo=timezone.utc),
            km_actual=30000,
            tipo="preventivo",
            costo=10000,
        ...
        Mantenimiento(
            id_vehiculo=14,
            id_empleado=3,
            fecha=datetime(2024, 2, 18, tzinfo=timezone.utc),
            km_actual=50000,
            tipo="correctivo",
            costo=35000,
            observaciones="Reparación del sistema de suspensión",
            km_prox_mant=20000,
            meses_prox_mant=18
        ),
    ]
